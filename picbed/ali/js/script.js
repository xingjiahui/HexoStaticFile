...
let isDragging = 0;
console.log("%c 小康博客 %c https://www.antmoe.com", "color:red;font-weight:bold;font-size:3em", "color:orange;font-weight:bold;font-size:3em");
...
const itemMarkup = (file, url, x, y) => {
  ...
  item.innerHTML = `<div class="item-img"><img src="${url}"/></div><div class="item-details"><div class="item-name">${
    file.name
